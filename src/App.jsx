...
import AddVial from './pages/AddVial'
  ...
  return (
    <div className="app">
      ...
      <main className="surface">
        {tab === 'calc' && <Calculator vials={vials} onLog={handleLog} />}
        {tab === 'add' && (
          <AddVial
            onSaved={() => {
              refreshVials()
        ...
        {tab === 'research' && <Research vial={activeVial} />}
      </main>
